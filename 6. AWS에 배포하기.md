...
- 프론트 인스턴스 접근: `ssh -i "namshter.pem" ubuntu@ec2-3-13-72-39.us-east-2.compute.amazonaws.com`
- 프론트 배포 고정IP 주소: http://3.13.72.39/
- 백엔드 인스턴스 접근: `ssh -i "namshter.pem" ubuntu@ec2-3-136-219-166.us-east-2.compute.amazonaws.com`
- 백엔드 배포 고정IP 주소: http://3.136.219.166
...
- nuxt.config.js에서 server부분에 rocess.env.PORT 을 추가한다.
